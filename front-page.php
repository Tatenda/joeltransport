                        ...
                        <div class="overlay px-4 pt-2">
                            ...
                            <div class="card_text">
                                <ul>
                                    ...
                                    <li>- Est. contents volume: 500 to 700 cubic feet</li>
                                    <li>- Move within 60km radius of Centurion</li>
                                </ul>
                            </div>
                            ...
                            <div class="overlay px-4 pt-2">
                                ...
                                <div class="card_text">
                                    <ul>
                                        ...
                                        <li>- Est. volume: 800 to 1,500 cubic feet</li>
                                        <li>- 60km radius of Centurion</li>
                                    </ul>
                                </div>
                                <div class="card_button">
                            ...
                            <div class="overlay px-4 pt-2">
                                ...
                                <div class="card_text">
                                    <ul>
                                        ...
                                        <li>- Est. volume: 1,600 to 2000 cubic feet</li>
                                        <li>- 60km radius of Centurion</li>
                                    </ul>
                                </div>
                                <div class="card_button">
                ...
                <div class="box m-2">
                    <div id="main-card" class="card shadow card_box">
                        ...
                        <div class="overlay px-4 pt-2">
                            ...
                            <div class="card_button">
                                <a name="" id="#card-back-button" class="btn_front btn" href="/contact"
                    ...
                    <div class="card shadow card_box">
                        <div class="overlay">
                            ...
                            <div class="overlay_description_text">
                                We safely store your furniture & belongings in crates or wooden pallet boxes at our
                                Gauteng facilities, for transit, short and long-term periods. On request we pack,
...
<section class="reviews">
    <div class="container">
        ...
        <div class="reviews_section">
            <div class="container">
                <?php echo do_shortcode('[trustindex data-widget-id=7ae3bf1884412453e254c10cf3]') ?>
            </div>
        </div>
    </div>
</section>
