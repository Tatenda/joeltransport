    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 ">
                ...
                <div class="moves">
                    <p>
                        Every day, Joel Transport offers unique moves and great experiences that make it possible for
                        our customers to feel at ease and have peace of mind. Go anywhere with Joel Transport, we offer
                        a full range of removal services for local moves in South Africa, from packing and loading to
                        transportation and unloading. Start now, get your non-binding quotation.

                        <br /><br />

                        No matter what type of move you’re making Joel Transport is here for you, our services are
                        tailored according to your needs. Are there access restrictions for big trucks in your complex
                        or estate? Do not worry, Joel Transport has got you, we got the right size truck just for you.
                        For peace of mind, insurance of your goods is available through our brokers for the safety and
                ...
                <div class="moves_details">
                    ...
                    <div class="moves">
                        <p>
                            ...
                            shipping to customs clearance and storage. To ensure that your move is smooth and seamless,
                            we assign you a personal move assistant to guide you through every step.

                            <br /><br />

                            The services we offer under International moves are: Lower Container Load Service – where
                            cargo is collected crated, consolidated and dispatched in 30 days period. This is a faster
                            convenient solution for our clients. Full Container Load Service – for larger loads of
                            either 6 or 12 cubic meter containers are used. This is faster and the most efficient
                            shipping method for larger loads. Air Freight Service, this is the most preferred method by
                            most customers, it is fast and safe.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="moves">
                    <p>
                        We provide storage facilities for your personal and household effects. We offer short and
                        long-term storage contracts. Loads are stored in Pallets within our warehouse With storages in
                        Gauteng and partnered facilities in Kwazulu Natal, the Eastern and Western Cape, Joel Transport
                        can offer its customers secure storage facilities to suit their specific requirements in those
                        regions.

                        <br /> <br />

                        Additional to furniture and personal belongings storage, we now offer our corporate clients
                        document storage solutions as well, through our sister company DSS we are able to assist with
                        physical and digital storage of your precious documentation
                    </p>
                </div>
            ...
            <div class="col-md-6 d_align">
                <div class="moves_img">
                    <img class="img-fluid"
                        src="https://joeltransport.co.za/wp-content/uploads/2022/08/Thumbnail-storage_600px-_-400px.jpg"
                        alt="" />
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 d_align">
                <div class="moves_details">
                    ...
                    <div class="moves">
                        <p>
                            For peace mind, all-risk insurance cover is available to all moving and storage customers.
                            The insurance services is handled by our accredited insurance brokers, speedily and
                            efficiently, just for you.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="moves_details">
                    ...
                    <div class="moves">
                        <p>
                            ...
                            packers, and we also do carton and custom crating service for
                            added protection.
                        </p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <p class="specialized_info" id="specialized_1">
                    ...
                    smaller members of your family comfortable.​ We treat your pets
                    with the utmost of care. Our staff are experts in the full
                    spectrum of regulations and legal requirements particular to pets
